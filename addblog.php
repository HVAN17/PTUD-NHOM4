...
<div class="main-content">
    ...
    <div class="card-header">
                ...
                <div class="card-body card-block">
                    <!-- Form thêm bài viết -->
                    <form action="database/save_blog.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="image" class="form-control-label">Chọn ảnh*</label>
                            </div>
                            <div class="col-12 col-md-9">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-sm">
                                <i class="fa fa-dot-circle-o"></i> Đăng bài viết
                            </button>
                        </div>
                    </form>
                </div>
